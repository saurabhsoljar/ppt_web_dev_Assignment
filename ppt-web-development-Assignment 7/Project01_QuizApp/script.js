const quizQuestions = [
  ...
  },
  {
    ...
    options: [
      ...
      "Adding interactivity and dynamic functionality",
  ...
  },
  {
    ...
    options: [
      ...
      "To target specific devices or screen sizes",
      "To add visual effects and animations",
  ...
  },
  {
    ...
    options: [
      ...
      "To display images and multimedia",
      "To create an interactive input interface",
    ],
    correctAnswer: "To create an interactive input interface",
  },
  {
    question:
      "Which technology is used to style web pages and define their appearance?",
